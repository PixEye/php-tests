...
?>
		<a href="<?php echo $base_url?>/language.constants.predefined.php"
			>PHP predefined constants<img alt="<?php echo $lg?>" <?php echo $iStyle?>
			src="../../img/flag-<?php echo $lg?>.gif"/></a>,
		<a href="<?php echo $base_url?>/reserved.constants.php"
			>PHP reserved constants<img alt="<?php echo $lg?>" <?php echo $iStyle?>
			src="../../img/flag-<?php echo $lg?>.gif"/></a>,
		<a href="<?php echo $base_url?>/dir.constants.php"
			>PHP manual for dir constants<img alt="<?php echo $lg?>" <?php echo $iStyle?>
...
<?php
echo "\t<div><b>__CLASS__</b> = <tt>", var_export(__CLASS__), '</tt></div>', NL;
if(defined('PHP_VERSION_ID') && PHP_VERSION_ID>=50300)
  echo "\t<div><b>__DIR__</b> = <tt>", var_export(__DIR__), '</tt></div>', NL;
echo "\t<div><b>__FILE__</b> = <tt>", var_export(__FILE__), '</tt></div>', NL;
echo "\t<div><b>__FUNCTION__</b> = <tt>", var_export(__FUNCTION__), '</tt></div>', NL;
echo "\t<div><b>__LINE__</b> = <tt>", var_export(__LINE__), '</tt></div>', NL;
echo "\t<div><b>__METHOD__</b> = <tt>", var_export(__METHOD__), '</tt></div>', NL;
if(defined('PHP_VERSION_ID') && PHP_VERSION_ID>=50300)
  echo "\t<div><b>__NAMESPACE__</b> = <tt>", var_export(__NAMESPACE__), '</tt></div>', NL;
if(defined('PHP_VERSION_ID') && PHP_VERSION_ID>=50400)
  echo "\t<div><b>__TRAIT__</b> = <tt>", var_export(__TRAIT__), '</tt></div>', NL;
?>
	</div>
	<div><br/></div>
<?php
$a = array('__FILE__', 'DIRECTORY_SEPARATOR', 'PATH_SEPARATOR',
